...
Telegram-бот **Aura Radar**: по контексту группового чата оценивает ауру автора сообщения (сильная / слабая / нейтральная). Канон судьи (TZ §1.2, §7.3): сильная = зал / winter arc / дисциплина; слабая = любовь / чувства / яп. Сам часто ставит реакции, редко пишет в чат, ведёт рейтинг очков **внутри чата**. `/aura` реплаем либо принудительно оценивает, либо объясняет уже стоящую реакцию.
